...
const AddUser=async()=>{
 ...
 if (password.length<6) {
  ...
  return (
    <SafeAreaView style={{flex:1,paddingVertical:10,paddingHorizontal:16,backgroundColor:'white'}}>
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps={'handled'} style={{backgroundColor:'white'}} contentContainerStyle={{justifyContent:'center',alignItems:'center'}}>

     
<Text style={{fontSize:24,fontFamily:'Outfit-SemiBold'}}>Create Account</Text>
<Text style={{fontSize:14,color:'#b2bec3',fontFamily:'Outfit-Light'}}>Start learning with create your account.</Text>
<View style={{flex:1,marginVertical:20}}>
<Text style={{fontSize:20,fontFamily:'Outfit-SemiBold'}}>Username</Text>
...
elevation: 15,display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',gap:8}}>
  ...
  <Icon name="user" size={27} color="#b2bec3" />
<TextInput style={{backgroundColor:'transparent',flex:1,fontSize:14,marginTop:4}} placeholder='Create Your Username' value={userName} onChangeText={setuserName}></TextInput>
...
<TextInput style={{flex:1,fontSize:14,marginTop:4}} inputMode='text' placeholder='Create Your Password' textContentType='password' secureTextEntry={!passwordVisible}  value={password}
...
elevation: 15}} onPress={onGoogleButtonPress}>
  ...
  <Text style={{alignSelf:'center',fontFamily:'Outfit-Black'}}>Sign Up with Google</Text>
</TouchableOpacity>
<TouchableOpacity style={{backgroundColor:'#f5f6fa',padding:14,borderRadius:22,display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',gap:8,shadowColor: "#000",
shadowOffset: {
	width: 0,
...
elevation: 15}} onPress={handleFacebookAuth}>
  ...
  <Text style={{alignSelf:'center',fontFamily:'Outfit-Black' }}>Sign Up with Facebook</Text>
</TouchableOpacity>
